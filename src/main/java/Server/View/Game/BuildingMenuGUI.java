...
public class BuildingMenuGUI {
    ...
    public void createGUI() {
        ...
        back.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                Client.View.Game.MapGUI.menusGUI.runMenu();
            }
        });
    ...
    private void showSelectedBuildingType() {
        ...
        ArrayList<Tile> selectedTiles = Client.View.Game.MapGUI.getSelectedTiles();
            ...
            ironMine.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent event) {
                    for (Tile tile: selectedTiles) {
                        ...
                        tile.showOnPane();  Client.View.Game.MapGUI.fixMap();
                    }
                }
            });
