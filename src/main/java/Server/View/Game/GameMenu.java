...
import Client.Model.Building.BuildingType;
...
import Client.View.Commands.GameMenuCommands;
import Client.View.Commands.MapMenuCommands;
import Client.View.Game.MapMenu;
import Client.View.Game.StoreMenu;
import Client.View.Game.TradeMenu;
...
public class GameMenu {
            ...
            for (Government government : GameMenuController.game.getGovernments()) {
                ...
                while (true) {
                    ...
                    if(command.matches("\\s*show\\s+related\\s+commands\\s*")) {
                        ...
                        int x = Integer.parseInt(matcher.group("X")), y = Integer.parseInt(matcher.group("Y"));
                        Client.View.Game.MapMenu.movingMap(x, y);
    ...
    private static void createMap() {
        ...
        Client.View.Game.MapMenu mapMenu = new MapMenu();
        mapMenu.run();
    }
