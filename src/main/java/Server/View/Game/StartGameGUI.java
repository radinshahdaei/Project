...
public class StartGameGUI extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Client.View.Game.GameMenu.numberOfTurns = 0;
        mapSize = 200;
        ...
        //Create default map
        Client.View.Game.GameMenu.valueDefaults();
        Map map = new Map();
        ...
        Client.View.Game.GameMenu.giveDefaultBuildings(government, counter);
        Client.View.Game.GameMenu.giveDefaultResources(government, (Storage) government.getBuildings().get(0));
        counter++;
        ...
        startGame.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                Client.View.Game.MapGUI mapGUI = new MapGUI();
                try {
                    mapGUI.start(stage);
                } catch (Exception e) {
