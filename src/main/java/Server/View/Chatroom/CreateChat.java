...
public class CreateChat extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Button startChat = new Button("Create chat with users: "+Controller.currentUser.getUsername());
        ...
        startChat.setOnAction(actionEvent -> {
            ...
            Client.View.Chatroom.Chatroom chatroom = new Client.View.Chatroom.Chatroom();
            ...
            for (Chat chat : Chat.allChats){
                for (User user : chat.getUsers()){
                    if (Controller.currentUser.getUsername().equals(user.getUsername())){
                        ...
                        Client.View.Chatroom.Chatroom chatroom = new Chatroom();
                        chatroom.setChat(chat);
                        try {
                            chatroom.start(new Stage());
                        try {
