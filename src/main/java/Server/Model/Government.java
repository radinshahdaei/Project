...
public class Government {
    ...
    public ArrayList<Client.Model.Trade> tradeList = new ArrayList<>();
    ...
    public Client.Model.User getUser() {
        return user;
    }
