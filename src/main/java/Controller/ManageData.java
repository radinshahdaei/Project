...
public class ManageData {
    public static void saveCurrentUser() {
        String json = new Gson().toJson(Controller.currentUser);
        try (FileWriter writer = new FileWriter("src/main/java/Controller/Data/currentUser.json")) {
            writer.write(json);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void saveUsers() {
        ...
        try (FileWriter writer = new FileWriter("src/main/java/Controller/Data/users.json")) {
            writer.write(json);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void saveGame() {
        ...
        try (FileWriter writer = new FileWriter("src/main/java/Controller/Data/game.json")) {
            writer.write(json);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static User loadCurrentUser() {
        File file = new File("src/main/java/Controller/Data/currentUser.json");
        Scanner reader = null;
        try {
            reader = new Scanner(file);
        } catch (FileNotFoundException e) {
    ...
    public static ArrayList<User> loadUsers() {
        File file = new File("src/main/java/Controller/Data/users.json");
        Scanner reader = null;
        try {
            reader = new Scanner(file);
        } catch (FileNotFoundException e) {
